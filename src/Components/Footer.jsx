      ...
      <div className="footer-bottom">
        <div className="container">
          <div className="section-wrapper">
            <p>
              &copy; {year} <Link to="/">Shop Cart </Link> Designed by
              <a href="https://www.linkedin.com/in/hamed-maklad-b8b907220?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank">
                Hamed Moataz
              </a>
            </p>
